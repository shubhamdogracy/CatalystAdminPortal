...
export const satAdminService = {
  ...
  getServedCount:    (id)           => req(`/sat/admin/question-bank/${id}/served-count`),
  deactivateQuestion:(id, payload)  => req(`/sat/admin/question-bank/${id}/deactivate`, { method: 'POST', body: JSON.stringify(payload) }),
  createNewVersion:  (id, payload)  => req(`/sat/admin/question-bank/${id}/new-version`, { method: 'POST', body: JSON.stringify(payload) }),
  getVersionHistory: (id)           => req(`/sat/admin/question-bank/${id}/history`),
